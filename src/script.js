$("#newtodo_form").on("submit", function (event) {
    ...
    const newTodoItem = `<div class="form-check col-auto todo_item"><input type="checkbox" onchange="handleChange(this)" class="form-check-input"><label class="form-check-label">${newTodo}</label></div>`;
